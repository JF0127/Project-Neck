...
用法:
    python tools/live/tts_align.py --text "你好,很高兴见到你" --name user --out-dir /tmp/neck_l1
    python tools/live/tts_align.py --voice zh-CN-YunxiNeural --text "..." --name bot
...
def main() -> None:
    ...
    ap.add_argument("--out-dir", default="/tmp/neck_l1", help="输出目录")
    ...
    res = tts_align(args.text, args.name, args.out_dir, args.voice,
